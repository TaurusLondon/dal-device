...
public class BundleHeaderForDevice {
	...
	@Override
	public int hashCode() {
		return Objects.hash(skuId, name, description, bundleName, bundleDescription, bundleClass, paymentType,
				bundleType, commitmentPeriod, allowance, roamingAllowance, merchandisingMedia, priceInfo);
	}
