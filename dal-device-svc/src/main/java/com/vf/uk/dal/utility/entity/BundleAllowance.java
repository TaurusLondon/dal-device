...
public class BundleAllowance {
	...
	/**
	 * Unit of measurement to be used for the allowance - \
	 * "MB\" for DATA. \"COUNT\" fpr TEXT amd \"MIN\" for CALL
	 * 
	 * @return uom
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.type, bundleAllowance.type) && Objects.equals(this.value, bundleAllowance.value)
