...
/**
 * A composite object which holds all the details about the various types of promotions applicable on the selected plan or hardware or the combination of both
 */
...
public class MerchandisingPromotionsPackage   {
  ...
  public MerchandisingPromotionsPackage planId(String planId) {
   ...
   /**
   * Unique identfier of the plan that was selected. Values are defined in Product Catalogue
   * @return planId
  **/
  ...
  public MerchandisingPromotionsPackage hardwareId(String hardwareId) {
   ...
   /**
   * Unique identfier of the hardware that was selected. Values are defined in Product Catalogue
   * @return hardwareId
  **/
