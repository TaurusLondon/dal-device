...
public class JourneyData {
	...
	/**
	 * The communication ID used when eCare invoked TIL GetMarketingOfferList.
	 * eShop must use this same value when populating TIL UpdateMarketingOffer.
	 * 
	...
	/**
	 * Account Roles like \
	 * "Owner\",\"Bill Payer\", \"Service User\", \"Admin L1\", \"Admin L2\", \"Store Collection\"
	 * 
	 * @return accountRoles
	 **/
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.name, journeyData.name) && Objects.equals(this.state, journeyData.state)
	...
	@Override
	public int hashCode() {
		return Objects.hash(name, state, customerPartyID, ssoCreatedDate, ownedCustomerPartyIDs, offerID,
				offerCommunicationID, upgradeEligibilityType, commitmentEndDate, earlyUpgradeFeeNet,
				earlyUpgradeFeeGross, accountRoles);
	}
