...
public class DeviceDetails {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.deviceId, deviceDetails.deviceId) && Objects.equals(this.name, deviceDetails.name)
	...
	@Override
	public int hashCode() {
		return Objects.hash(deviceId, name, description, validOffer, productClass, productLines, merchandisingControl,
				merchandisingPromotion, stockAvailability, rating, productPageURI, equipmentDetail, leadPlanId,
				productAvailability, media, specificationsGroups, priceInfo, metaData);
	}
