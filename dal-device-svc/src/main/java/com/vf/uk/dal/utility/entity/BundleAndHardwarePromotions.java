...
public class BundleAndHardwarePromotions {
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions sashBannerForHardware(
	 ...
	 *            the sash banner for hardware item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addSashBannerForHardwareItem(
			CataloguepromotionqueriesForHardwareSash sashBannerForHardwareItem) {
	 ...
	 *
	 * @param sashBannerForHardware
	 *            the new sash banner for hardware
	 */
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions freeExtras(
	 ...
	 *            the free extras item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addFreeExtrasItem(
			CataloguepromotionqueriesForBundleAndHardwareExtras freeExtrasItem) {
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions freeAccessory(
			List<CataloguepromotionqueriesForBundleAndHardwareAccessory> freeAccessory) {
	 ...
	 *            the free accessory item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addFreeAccessoryItem(
			CataloguepromotionqueriesForBundleAndHardwareAccessory freeAccessoryItem) {
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions planCouplingPromotions(
	 ...
	 *            the plan coupling promotions item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addPlanCouplingPromotionsItem(
			CataloguepromotionqueriesForBundleAndHardwarePlanCouplingPromotions planCouplingPromotionsItem) {
	 ...
	 *
	 * @param planCouplingPromotions
	 *            the new plan coupling promotions
	 */
	public void setPlanCouplingPromotions(
			List<CataloguepromotionqueriesForBundleAndHardwarePlanCouplingPromotions> planCouplingPromotions) {
		this.planCouplingPromotions = planCouplingPromotions;
	}
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions dataAllowances(
	 ...
	 *            the data allowances item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addDataAllowancesItem(
			CataloguepromotionqueriesForBundleAndHardwareDataAllowances dataAllowancesItem) {
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions entertainmentPacks(
	 ...
	 *            the entertainment packs item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addEntertainmentPacksItem(
			CataloguepromotionqueriesForBundleAndHardwareEntertainmentPacks entertainmentPacksItem) {
	 ...
	 *
	 * @param entertainmentPacks
	 *            the new entertainment packs
	 */
	public void setEntertainmentPacks(
			List<CataloguepromotionqueriesForBundleAndHardwareEntertainmentPacks> entertainmentPacks) {
		this.entertainmentPacks = entertainmentPacks;
	}
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions sashBannerForPlan(
			List<CataloguepromotionqueriesForBundleAndHardwareSash> sashBannerForPlan) {
	 ...
	 *            the sash banner for plan item
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addSashBannerForPlanItem(
			CataloguepromotionqueriesForBundleAndHardwareSash sashBannerForPlanItem) {
	 ...
	 *            the new free extras for hardware
	 */
	public void setFreeExtrasForHardware(
			List<CataloguepromotionqueriesForBundleAndHardwareExtras> freeExtrasForHardware) {
	...
	public void setConditionalSashBanner(
			List<CataloguepromotionqueriesForBundleAndHardwareSash> conditionalSashBanner) {
		this.conditionalSashBanner = conditionalSashBanner;
	}

	public BundleAndHardwarePromotions conditionalSashBanner(
			List<CataloguepromotionqueriesForBundleAndHardwareSash> conditionalSashBanner) {
		this.conditionalSashBanner = conditionalSashBanner;
		return this;
	}
	 ...
	 * @return the bundle and hardware promotions
	 */
	public BundleAndHardwarePromotions addConditionalSashBanner(
			CataloguepromotionqueriesForBundleAndHardwareSash conditionalSashBanner) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(bundleId, hardwareId, sashBannerForHardware, freeExtras, freeAccessory,
				planCouplingPromotions, dataAllowances, entertainmentPacks, sashBannerForPlan);
	}
