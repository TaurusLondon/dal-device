...
public class DaoUtils {
	...
	public static DeviceSummary convertCoherenceDeviceToDeviceTile(Long memberPriority,
		...
		if (groupType != null && groupType.equals(Constants.STRING_DEVICE_PAYG)) {
			...
			PriceForBundleAndHardware priceForBundleAndHardware = getBundleAndHardwarePrice(priceforBundleAndHardware,
					commercialProduct.getId(), isConditionalAcceptJourney, comBundle);
	...
	public static PriceForAccessory getPriceForAccessory(PriceForAccessory priceForAccessory) {
		if (priceForAccessory != null) {
			if (priceForAccessory.getHardwarePrice() != null
					&& priceForAccessory.getHardwarePrice().getOneOffPrice() != null
					...
					&& priceForAccessory.getHardwarePrice().getOneOffPrice().getGross().equalsIgnoreCase(
							priceForAccessory.getHardwarePrice().getOneOffDiscountPrice().getGross())) {
	...
	public static Map<String, Object> getPriceInfoForSolr(
		...
		if (bundlePrice != null && bundlePrice.getMonthlyPrice() != null
			...
			if (bundlePrice.getMerchandisingPromotions() != null) {
				...
				mediaLink.setId(
						bundlePrice.getMerchandisingPromotions().getMpType() + "." + Constants.STRING_OFFERS_LABEL);
				...
				if (StringUtils.isNotBlank(bundlePrice.getMerchandisingPromotions().getDiscountId())) {
					mediaLinkForPromotionMedia.setDiscountId(bundlePrice.getMerchandisingPromotions().getDiscountId());
				} else {
	...
	public static Map<String, Object> getListOfOfferAppliedPrice(String deviceId,
		...
		for (Entry<String, Map<String, Map<String, List<com.vf.uk.dal.utility.entity.PriceForBundleAndHardware>>>> ilsJourneyEntry : ilsPriceForBundleAndHardwareMap
			...
			Map<String, Map<String, List<com.vf.uk.dal.utility.entity.PriceForBundleAndHardware>>> listOfPriceForBundleAndHardwareMap = ilsJourneyEntry
					.getValue();
					...
					priceForBundleAndHardwareWithOfferCodeList.forEach(priceForBundleAndHardwareWithOfferCode -> {
						...
						if (bundlePrice != null) {
							...
							if (bundlePrice.getMerchandisingPromotions() != null) {
								...
								mediaLinkForPromotionMedia.setPromoCategory(Constants.PROMO_CATEGORY_PRICING_DISCOUNT);
	...
	public com.vf.uk.dal.utility.entity.PriceForBundleAndHardware getListOfPriceForBundleAndHardwareForCacheDevice(
		...
		try {
			...
			if (listOfPriceForBundleHeaderLocal != null && !listOfPriceForBundleHeaderLocal.isEmpty()) {
				...
				List<com.vf.uk.dal.utility.entity.PriceForBundleAndHardware> listOfPriceForBundleHeader = listOfPriceForBundleHeaderLocal
						.stream().filter(price -> CommonUtility.isValidBundleForProduct(price, commercialbundleMap,
	 ...
	 */
	private static MerchandisingPromotionsPackage assembleMechandisingPromotionsPackageGeneric(
