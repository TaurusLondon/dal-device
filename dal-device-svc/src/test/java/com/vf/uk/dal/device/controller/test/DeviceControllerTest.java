...
public class DeviceControllerTest {
	 ...
	 * "http://BUNDLES-V1/bundles/catalogue/bundle/queries/byCoupledBundleList/?deviceId="
	 ...
	 * CommonMethods.getCommercialProductsListOfMakeAndModel().get(0));
	 ...
	 * CommonMethods.getCommercialBundleFromCommercialBundleRepository());
	 * given(response.getListOfMerchandisingPromotionFromJson(Matchers.anyObject
	 * ())).willReturn(CommonMethods.getMerchandisingPromotion1()); String
	 * jsonString1 = new
	 ...
	 * given(this.deviceDAOMock.getProductGroupByGroupTypeGroupName("ValidData",
	 * null)).willReturn(null);
	 * given(this.deviceDAOMock.getProductGroupByGroupTypeGroupName("DEVgikyj",
	 ...
	 * given(this.deviceDAOMock.getDeviceTileById("83987", null,
	 * null)).willReturn(null); given(this.deviceDAOMock.getDeviceTileById(null,
	 * null, null)).willReturn(null);
	 * 
	 ...
	 * given(this.deviceDAOMock.getStockAvailability("SIMO")).willReturn(
	 * CommonMethods.getStockInfo()); //
	 * given(this.deviceDAOMock.getStockAvailability("ValidData")).willReturn(
	 * CommonMethods.getListOfStockInfo());
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson());
	 * 
	 * }
	 * 
	 * @Test public void notNullTestForGetDeviceDetailsTile() { List<DeviceTile>
	 * deviceDetails = null;
	 * given(response.getCommercialProductFromJson(Matchers.anyObject())).
	 * willReturn(CommonMethods.getCommercialProductsListOfMakeAndModel());
	 * given(response.getListOfGroupFromJson(Matchers.anyObject())).willReturn(
	 * CommonMethods.getListOfProductGroupFromProductGroupRepository());
	 * given(deviceDAOMock.getPriceForBundleAndHardwareListFromTupleListAsync(
	 * Matchers.anyList(), Matchers.anyString(), Matchers.anyString(),
	 * Matchers.anyString())).willReturn(CommonMethods.
	 * getPriceForBundleAndHardwareListFromTupleListAsync()); try {
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", null, null, null, null, null);
	 * Assert.assertNotNull(deviceDetails); deviceDetails =
	 * deviceController.getListOfDeviceTile("Apple", "iPhone-7", "DEVICE_PAYM",
	 * null, null, null, null, null); } catch (Exception e) {
	 * 
	 * }
	 * 
	 * }
	 * 
	 * @Test public void notNullTestForGetDeviceDetailsTileWithBundleId() {
	 ...
	 * Matchers.anyString(),Matchers.anyString())).willReturn(CommonMethods.
	 * getPriceForBundleAndHardwareListFromTupleListAsync());
	 * given(deviceDAOMock.getBundleAndHardwarePromotionsListFromBundleListAsync
	 * (Matchers.anyList(), Matchers.anyString(),
	 * Matchers.anyString())).willReturn(CommonMethods.
	 * getBundleAndHardwarePromotionsListFromBundleListAsync()); try {
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", null, null, "110345", null, null);
	 * Assert.assertNotNull(deviceDetails); deviceDetails =
	 * deviceController.getListOfDeviceTile("Apple", "iPhone-7", "DEVICE_PAYM",
	 * "Upgrade", null, null, null, null); } catch (Exception e) {
	 * 
	 * }
	 * 
	 * }
	 * 
	 * @Test public void notNullTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "ConditionalAccept", null, null, "091210", "60.00");
	 * Assert.assertNotNull(deviceDetails); } catch (Exception e) {
	 * 
	 * }
	 * 
	 * }
	 * 
	 * @Test public void
	 * invalidCreditLimitNullTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "ConditionalAccept", null, null, "091210", "test");
	 * 
	 * } catch (Exception e) { Assert.assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Please enter valid credit limit."
	 * , e.toString()); }
	 * 
	 * }
	 * 
	 * @Test public void
	 * nullCreditLimitNullTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try { deviceDetails =
	 * deviceController.getListOfDeviceTile("Apple", "iPhone-7", "DEVICE_PAYM",
	 ...
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidBundleIdTestforGetDeviceDetails() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "ConditionalAccept", null, "abcd", "091210", "60.0");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Invalid Bundle Id Sent In Request"
	 * , e.toString()); } }
	 * 
	 * @Test public void
	 * noCreditLimitNullTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", null, null, null, "091210", null);
	 * 
	 * } catch (Exception e) { Assert.assertEquals(
	 ...
	 * 
	 * @Test public void
	 * invalidContextNameTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "Upgrade", null, null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Please enter valid context name."
	 * , e.toString()); }
	 * 
	 * }
	 * 
	 * @Test public void
	 * nullContextNameTestForGetDeviceDetailsTileConditionalAccept() {
	 * List<DeviceTile> deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", null, null, null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Please enter valid context name."
	 * , e.toString()); }
	 ...
	 * }
	 * 
	 * @Test public void notNullTestForconvertDevicePreCalDataToSolrData() {
	 * DaoUtils.convertDevicePreCalDataToSolrData(CommonMethods.getDevicePreCal(
	 * )); }
	 * 
	 * @Test public void notNullTestForGetProductGroupListWithValidInput() {
	 * List<ProductGroup> productGroupList = new ArrayList<ProductGroup>(); try
	 * { List<FilterCriteria> fcList = new ArrayList<FilterCriteria>();
	 * fcList.add(new FilterCriteria("groupType", FilterOperator.EQUALTO,
	 * "DEVICE")); fcList.add(new FilterCriteria("groupName",
	 * FilterOperator.EQUALTO, "Apple iPhone 7"));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null)); productGroupList = deviceController.getProductGroup();
	 * ServiceContext.urlParamContext.remove(); } catch (Exception e) {
	 * 
	 * } Assert.assertNotNull(productGroupList); }
	 * 
	 * @Test public void sizeTestForGetDeviceDetailsTile() { List<DeviceTile>
	 * deviceDetails = null; try { List<FilterCriteria> fcList = new
	 * ArrayList<FilterCriteria>(); fcList.add(new FilterCriteria("make",
	 * FilterOperator.EQUALTO, null)); fcList.add(new FilterCriteria("model",
	 * FilterOperator.EQUALTO, "iPhone-7")); fcList.add(new
	 * FilterCriteria("groupType", FilterOperator.EQUALTO, "DEVICE"));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null)); deviceDetails = deviceController.getListOfDeviceTile(null,
	 * "iPhone-7", "DEVICE_PAYM", null, null, null, null, null);
	 * ServiceContext.urlParamContext.remove(); } catch (Exception e) {
	 * 
	 * } Assert.assertNull(deviceDetails); }
	 * 
	 * @Test public void notNullTestForGetProductGroupList() throws Exception {
	 * List<ProductGroup> productGroupList = new ArrayList<ProductGroup>(); try
	 * { ServiceContext.urlParamContext.remove(); productGroupList =
	 * deviceController.getProductGroup(); } catch (Exception e) {
	 * 
	 * } Assert.assertNotNull(productGroupList); }
	 * 
	 * @Test public void nullTestForGetProductGroupListWithInvalidInput() throws
	 * Exception {
	 * 
	 * ServiceContext.urlParamContext.remove(); List<FilterCriteria> fcList =
	 * new ArrayList<FilterCriteria>(); fcList.add(new
	 * FilterCriteria("groupType", FilterOperator.EQUALTO, "DEVgikyj"));
	 * fcList.add(new FilterCriteria("groupName", FilterOperator.EQUALTO,
	 * "Apple iPhone 7")); ServiceContext.setURLParamContext(new
	 * URLParamContext("", "", fcList, null)); List<ProductGroup>
	 * productGroupList = deviceController.getProductGroup();
	 * ServiceContext.urlParamContext.remove();
	 * Assert.assertNull(productGroupList); }
	 * 
	 * @Test public void notNullTestgetDeviceTileById() { try { List<DeviceTile>
	 * deviceTileList = new ArrayList<DeviceTile>(); deviceTileList =
	 * deviceController.getDeviceTileById("83921",null,null);
	 * Assert.assertNotNull(deviceTileList); deviceTileList =
	 * deviceController.getDeviceTileById("83921",null,null); } catch (Exception
	 * e) {
	 * 
	 * }
	 * 
	 * }
	 * 
	 * @Test public void nullTestgetDeviceTileById() { try { List<DeviceTile>
	 * deviceTileList = new ArrayList<DeviceTile>(); deviceTileList =
	 * deviceController.getDeviceTileById("83987",null,null); } catch (Exception
	 ...
	 * }
	 * 
	 * @Test public void invalidInputTestgetDeviceTileById() throws Exception {
	 * List<DeviceTile> deviceTileList = new ArrayList<DeviceTile>(); try {
	 * 
	 ...
	 * 
	 * @Test public void notNullTestForgetDeviceDetailsWithJourneyType() {
	 * DeviceDetails deviceDetails = new DeviceDetails(); deviceDetails =
	 * deviceController.getDeviceDetails("083921", "", "");
	 * Assert.assertNotNull(deviceDetails); }
	 * 
	 * @Test public void invalidInputTestForgetDeviceDetails() throws Exception
	 * { DeviceDetails deviceDetails = new DeviceDetails(); try { deviceDetails
	 * = deviceController.getDeviceDetails(null, null, null); } catch (Exception
	 * e) {
	 * 
	 * } Assert.assertNull(deviceDetails.getDeviceId()); }
	 * 
	 * @Test public void invalidInputTestForgetDeviceDetails1() throws Exception
	 * { DeviceDetails deviceDetails = new DeviceDetails(); try { deviceDetails
	 * = deviceController.getDeviceDetails("1234", null, null); } catch
	 * (Exception e) {
	 * 
	 * } }
	 * 
	 * @Test public void notNullTestForgetDeviceDetails() { DeviceDetails
	 * deviceDetails = new DeviceDetails();
	 * 
	 * deviceDetails = deviceController.getDeviceDetails("093353", "", "");
	 * Assert.assertNotNull(deviceDetails); }
	 * 
	 * @Test public void notNullTestForGetAccessoriesOfDevice() { try {
	 * List<AccessoryTileGroup> accessoryDetails = new ArrayList<>();
	 * accessoryDetails = deviceController.getAccessoriesOfDevice("093353",
	 * "Upgrade", "W_HH_PAYM_OC_02"); Assert.assertNotNull(accessoryDetails); //
	 * accessoryDetails = //
	 * deviceController.getAccessoriesOfDevice("093353",null,null); } catch
	 * (Exception e) {
	 * 
	 * } }
	 * 
	 * @Test public void nullValueTestForGetAccessoriesOfDevice() {
	 * List<AccessoryTileGroup> accessoryDetails = new ArrayList<>(); try {
	 * 
	 * accessoryDetails = deviceController.getAccessoriesOfDevice(null, null,
	 * null); } catch (Exception e) { try {
	 * 
	 * accessoryDetails = deviceController.getAccessoriesOfDevice("1234", null,
	 * null); } catch (Exception ex) {} } Assert.assertEquals(0,
	 * accessoryDetails.size()); }
	 * 
	 * @Test public void nullTestForGetInsuranceById() { Insurances insurance =
	 * null; try { insurance = deviceController.getInsuranceById(null, null); }
	 * catch (Exception e) {
	 * 
	 * } Assert.assertNull(insurance); }
	 * 
	 ...
	 * @JsonIgnore
	 * 
	 * @Test public void notNullTestForcacheDeviceTile() throws
	 * JsonParseException, JsonMappingException, IOException {
	 * ServiceContext.urlParamContext.remove(); List<FilterCriteria> fcList =
	 * new ArrayList<FilterCriteria>(); fcList.add(new
	 * FilterCriteria("groupType", FilterOperator.EQUALTO, "DEVICE_PAYM"));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null));
	 * given(deviceDAOMock.insertCacheDeviceToDb()).willReturn(CommonMethods.
	 * getCacheDeviceTileResponse()); List<CommercialProduct> a = new
	 * ArrayList<>(); a.add(CommonMethods.getCommercialProduct5());
	 * given(response.getCommercialProductFromJson(Matchers.anyObject())).
	 * willReturn(a); List<CommercialBundle> listOfCommerCualBundle = new
	 * ArrayList<>();
	 ...
	 * given(deviceDAOMock.getStockAvailabilityByMemberId(Matchers.anyString()))
	 * .willReturn(CommonMethods.getStockAvailability()); ObjectMapper mapper =
	 * new ObjectMapper();
	 * mapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
	 * mapper.enable(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY);
	 * String jsonString = new
	 * String(Utility.readFile("\\rest-mock\\PRICE-V1.json"));
	 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[] obj =
	 * mapper.readValue(jsonString,
	 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[].class);
	 * given(registry.getRestTemplate()).willReturn(restTemplate); try {
	 ...
	 * RequestForBundleAndHardware(); BundleAndHardwareTuple bundle = new
	 * BundleAndHardwareTuple(); bundle.setBundleId("110154");
	 * bundle.setHardwareId("123"); bundleList.add(bundle);
	 ...
	 * }
	 * 
	 * @Test public void notNullTestForcacheDeviceTileWithoutLeadMember() throws
	 * IOException { List<FilterCriteria> fcList = new
	 * ArrayList<FilterCriteria>(); fcList.add(new FilterCriteria("groupType",
	 * FilterOperator.EQUALTO, "DEVICE_PAYM"));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null));
	 * 
	 * given(deviceDAOMock.insertCacheDeviceToDb()).willReturn(CommonMethods.
	 * getCacheDeviceTileResponse()); CommercialProduct com =
	 * CommonMethods.getCommercialProductForCacheDeviceTile();
	 * com.setLeadPlanId(null); CommercialProduct com1 =
	 * CommonMethods.getCommercialProductForCacheDeviceTile1();
	 * List<CommercialProduct> a = new ArrayList<>(); a.add(com); a.add(com1);
	 * given(response.getCommercialProductFromJson(Matchers.anyObject())).
	 * willReturn(a); List<CommercialBundle> listOfCommerCualBundle = new
	 * ArrayList<>();
	 * listOfCommerCualBundle.add(CommonMethods.getCommercialBundle());
	 * given(response.getListOfCommercialBundleFromJson(Matchers.anyObject())).
	 * willReturn(listOfCommerCualBundle); ObjectMapper mapper = new
	 * ObjectMapper();
	 * mapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
	 * mapper.enable(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY);
	 * String jsonString1 = new
	 * String(Utility.readFile("\\rest-mock\\PRICE-V1.json"));
	 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[] obj1 =
	 * mapper.readValue(jsonString1,
	 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[].class);
	 * given(registry.getRestTemplate()).willReturn(restTemplate);
	 * RequestForBundleAndHardware requestForBundleAndHardware = new
	 * RequestForBundleAndHardware(); List<BundleAndHardwareTuple> bundleList =
	 * new ArrayList<>(); BundleAndHardwareTuple bundle = new
	 * BundleAndHardwareTuple(); bundle.setBundleId("109154");
	 * bundle.setHardwareId("123"); bundleList.add(bundle);
	 * requestForBundleAndHardware.setBundleAndHardwareList(bundleList);
	 * requestForBundleAndHardware.setOfferCode("W_HH_PAYM_OC_01");
	 * given(restTemplate.postForObject(
	 ...
	 * 
	 * String jsonString = new
	 * String(Utility.readFile("\\rest-mock\\BUNDLES-V1.json")); ObjectMapper
	 ...
	 * BundleDetailsForAppSrv.class)).willReturn(obj); try {
	 ...
	 * 
	 * 
	 * @Test public void testCacheDeviceTileStatus() {
	 * given(deviceDAOMock.getCacheDeviceJobStatus("testID")).willReturn(
	 * CommonMethods.getCacheDeviceTileResponse()); CacheDeviceTileResponse
	 * response = deviceController.getCacheDeviceJobStatus("testID");
	 ...
	 * }
	 * 
	 * @Test public void testGetListOfDeviceTileForNullDeviceID() {
	 * List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
	 * deviceController.getListOfDeviceTile(null, "iPhone-7", "DEVICE_PAYM",
	 * null, null, null, "123", null); } catch (Exception e) { } }
	 * 
	 * @Test public void testGetListOfDeviceTileForNullBundleID() {
	 * List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
	 * deviceController.getListOfDeviceTile("Apple", "iPhone-7", "DEVICE_PAYM",
	 * null, null, "123", null, null); } catch (Exception e) { } }
	 * 
	 * @Test public void testGetListOfDeviceTileForNullMakeAndModel() {
	 * List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
	 * deviceController.getListOfDeviceTile(null, null, "DEVICE_PAYM", null,
	 * null, null, null, null); } catch (Exception e) { } }
	 * 
	 * @Test public void testGetListOfDeviceTileForNullMake() { List<DeviceTile>
	 * listOfDeviceTile = null; try { listOfDeviceTile =
	 * deviceController.getListOfDeviceTile(null, "iPhone-7", "DEVICE_PAYM",
	 * null, null, null, null, null); } catch (Exception e) {
	 * Assert.assertEquals(
	 ...
	 * , e.toString()); } }
	 * 
	 * @Test public void testGetListOfDeviceTileForNullModel() {
	 * List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
	 * deviceController.getListOfDeviceTile("Apple", null, null, null, null,
	 * null, null, null); } catch (Exception e) { Assert.assertEquals(
	 ...
	 * , e.toString()); } }
	 * 
	 * @Test public void testGetKeepDeviceChangePlan() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 ...
	 * keepDeviceChangePlanRequest.setPlansLimit("3"); try { BundleDetails
	 * bundleDetails =
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } // Assert.assertNotNull(bundleDetails);
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanInvalidInput() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = null; try {
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid input request received", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanAllInvalidInput() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest(); try {
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid input request received", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullDeviceId() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId(null);
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 * keepDeviceChangePlanRequest.setAllowedRecurringPriceLimit("60");
	 * keepDeviceChangePlanRequest.setPlansLimit("3"); try {
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (ApplicationException e) { Assert.assertEquals(
	 * "Invalid input request received. Missing Device Id", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullDeviceId1() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (ApplicationException e) { Assert.assertEquals(
	 * "Invalid Device Id Sent In Request", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullBundleId() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid input request received. Missing Bundle Id", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullBundleId1() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid Bundle Id Sent In Request", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void
	 * testGetKeepDeviceChangePlanForNullAllowedRecurringPriceLimit() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid input request received. Missing AllowedRecurringPriceLimit",
	 * e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void
	 * testGetKeepDeviceChangePlanForNullAllowedRecurringPriceLimit1() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid AllowedRecurringPriceLimit Sent In Request", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullPlansLimit() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 * keepDeviceChangePlanRequest.setAllowedRecurringPriceLimit("60");
	 * keepDeviceChangePlanRequest.setPlansLimit(null); try {
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid input request received. Missing Plans Limit", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForNullPlansLimit1() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 * keepDeviceChangePlanRequest.setAllowedRecurringPriceLimit("60");
	 * keepDeviceChangePlanRequest.setPlansLimit("abc"); try {
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "Invalid Plans Limit Sent In Request", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForEmptyDataLimit() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson1());
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "No Compatible Plans List found for given device Id", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForSingle() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson5());
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110151");
	 * keepDeviceChangePlanRequest.setAllowedRecurringPriceLimit("73");
	 * keepDeviceChangePlanRequest.setPlansLimit("3"); BundleDetails
	 * bundleDetails; try { bundleDetails =
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } // Assert.assertNotNull(bundleDetails);
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForError() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * deviceController.getKeepDeviceChangePlan(keepDeviceChangePlanRequest); }
	 * catch (Exception e) { Assert.assertEquals(
	 * "No Similar Plan Found For Given Device Id", e.getMessage()); }
	 * 
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForInvalidBundleIdError() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson());
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 ...
	 * }
	 * 
	 * @Test public void testGetKeepDeviceChangePlanForCompatibleError() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)).willReturn(null); KeepDeviceChangePlanRequest
	 * keepDeviceChangePlanRequest = new KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 * keepDeviceChangePlanRequest.setAllowedRecurringPriceLimit("10");
	 * keepDeviceChangePlanRequest.setPlansLimit("3"); try {
	 ...
	 * 
	 * @Test public void
	 * testGetKeepDeviceChangePlanForSingleAfterSameMonthlyCost() {
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * 
	 * @Test public void
	 * testGetKeepDeviceChangePlanForSingleAfterSameMonthlyCostException() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson3());
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * 
	 * @Test public void
	 * testGetKeepDeviceChangePlanForSingleAfterSameMonthlyCostException1() {
	 * given(this.deviceDAOMock.getBundleDetailsFromComplansListingAPI("093353",
	 * null)) .willReturn(CommonMethods.getCompatibleBundleListJson4());
	 * KeepDeviceChangePlanRequest keepDeviceChangePlanRequest = new
	 * KeepDeviceChangePlanRequest();
	 * keepDeviceChangePlanRequest.setDeviceId("093353");
	 * keepDeviceChangePlanRequest.setBundleId("110091");
	 ...
	 * testGetDeviceReviewDetailsNull() {
	 * given(this.deviceDAOMock.getDeviceReviewDetails("093353")).willReturn(
	 * null); deviceController.getDeviceReviewDetails("093353"); }
	 * 
	 * 
	 ...
	 * isEmpty()); }
	 * 
	 * @Test public void notNullTestForgetListOfDeviceDetails() {
	 * List<DeviceDetails> deviceDetails;
	 * given(deviceDAOMock.getPriceForBundleAndHardware(Matchers.anyList(),
	 * Matchers.anyString(), Matchers.anyString())).willReturn(CommonMethods.
	 * getPriceForBundleAndHardwareListFromTupleList()); deviceDetails =
	 * deviceController
	 * .getListOfDeviceDetails(CommonMethods.getQueryParamsMapForDeviceDetails(
	 * "093353")); Assert.assertNotNull(deviceDetails); }
	 * 
	 * @Test public void notNullTestForgetListOfDeviceDetailsWithoutLeadPlanId()
	 * { List<DeviceDetails> deviceDetails; CommercialProduct
	 * commercial=CommonMethods.getCommercialProductByDeviceId_093353();
	 ...
	 * "093353")); Assert.assertNotNull(deviceDetails); }
	 * 
	 * @Test public void emptyParamTestForgetListOfDeviceDetails() throws
	 * Exception { List<DeviceDetails> deviceDetails = null; try { deviceDetails
	 * = deviceController
	 * .getListOfDeviceDetails(CommonMethods.getQueryParamsMapForDeviceDetails(
	 ...
	 * } Assert.assertNull(deviceDetails); }
	 * 
	 * @Test public void invalidParamTestForgetListOfDeviceDetails() throws
	 * Exception { List<DeviceDetails> deviceDetails = null; try { deviceDetails
	 * = deviceController
	 * .getListOfDeviceDetails(CommonMethods.getQueryParamsMapForDeviceDetails(
	 ...
	 * } Assert.assertNull(deviceDetails); }
	 * 
	 * @Test public void testDaoUtilsconvertCoherenceDeviceToDeviceTile() {
	 * DaoUtils.convertCoherenceDeviceToDeviceTile(Long.valueOf(1),
	 * CommonMethods.getCommercialProduct1(),
	 * CommonMethods.getCommercialBundle(),
	 * CommonMethods.getPriceForBundleAndHardware().get(0),
	 * CommonMethods.getListOfBundleAndHardwarePromotions(), "DEVICE_PAYM",
	 * false, null); }
	 * 
	 * @Test public void testDaoUtilsconvertCoherenceDeviceToDeviceDetails() {
	 ...
	 * 
	 * @Test public void testDaoUtilsconvertGroupProductToProductGroupDetails()
	 * { DaoUtils.convertGroupProductToProductGroupDetails(CommonMethods.
	 * getProductGroupModel()); }
	 * 
	 * @Test public void notNullTestForGetInsuranceById() {
	 * 
	 * 
	 * try { Insurances insurance = null; insurance =
	 * deviceController.getInsuranceById("093353", null);
	 * Assert.assertNotNull(insurance); insurance =
	 * deviceController.getInsuranceById("93353", null); } catch (Exception e) {
	 * } }
	 * 
	 * @Test public void notNullTestForGetInsuranceByIdWithJourneyType() {
	 ...
	 * )));
	 * 
	 * try { Insurances insurance = null; Map<String, String> queryparams = new
	 * HashMap<String, String>(); queryparams.put("deviceId", "093353");
	 * queryparams.put("journeyType", "upgrade"); Map<String, String>
	 * queryparamsInvalid = new HashMap<String, String>();
	 * queryparamsInvalid.put("deviceId", "093353");
	 * queryparamsInvalid.put("journeyType", "test"); insurance =
	 * deviceController.getInsuranceById("093353", "upgrade");
	 * Assert.assertNotNull(insurance); insurance =
	 * deviceController.getInsuranceById("093353", "test"); } catch (Exception
	 * e) { } }
	 * 
	 * @Test public void nullOfferCodeforMakeModel() { List<DeviceTile>
	 * deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", null, "W_HH_OC_02", null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Required JourneyType with Offercode."
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeforMakeModel() { List<DeviceTile>
	 * deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "Upgrade", "W_HH_OC_02", null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: OfferCode is not compatible with JourneyType"
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeforsimoMakeModel() { List<DeviceTile>
	 * deviceDetails = null; try {
	 * 
	 * deviceDetails = deviceController.getListOfDeviceTile("Apple", "iPhone-7",
	 * "DEVICE_PAYM", "SecondLine", "W_HH_OC_02", null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: OfferCode is not compatible with JourneyType"
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeMakeModel() { List<DeviceTile>
	 * deviceDetails = null; try {
	 * 
	 * // queryparams.put("offerCode", "W_HH_OC_02_1"); deviceDetails =
	 * deviceController.getListOfDeviceTile("Apple", "iPhone-7", "DEVICE_PAYM",
	 * "test", null, null, "091210", "123");
	 * 
	 * } catch (Exception e) { Assert.assertNotNull(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Received invalid journeyType in the request."
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeforsimoDeviceDetails() { try {
	 * deviceController.getDeviceDetails("083921", "SecondLine",
	 * "W_HH_PAYM_OC_01"); } catch (Exception e) { Assert.assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: JourneyType is not compatible for given DeviceId"
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeDeviceDetails() { try {
	 * deviceController.getDeviceDetails("083921", "test", null); } catch
	 * (Exception e) { Assert.assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: Received invalid journeyType in the request."
	 * , e.toString()); } }
	 * 
	 * @Test public void nullOfferCodeforDeviceDetails() { try {
	 * deviceController.getDeviceDetails("083921", null, "W_HH_OC_02"); } catch
	 * (Exception e) { Assert.assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: offerCode is not compatible for given DeviceId"
	 * , e.toString()); } }
	 * 
	 * @Test public void invalidJourneyTypeforDeviceDetails() { try {
	 * deviceController.getDeviceDetails("083921", "Upgrade",
	 * "W_HH_SIMONLY_02"); } catch (Exception e) { Assert.assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: JourneyType is not compatible for given DeviceId"
	 * , e.toString()); } }
	 * 
	 * @Test public void nullOfferCodeforDeviceList() { try { PaginationCriteria
	 * paginationCriteria = new PaginationCriteria(9, 0);
	 * ServiceContext.setURLParamContext(new URLParamContext("Priority", "",
	 * null, paginationCriteria)); deviceController.getDeviceList("HANDSET",
	 * "DEVICE_PAYM", "Priority", 1, 9, "Apple", "iPhone-7", "White", "iOS 9",
	 ...
	 * 
	 * 
	 * @Test public void invalidJourneyTypeDeviceList() { try {
	 ...
	 * 
	 * } catch (Exception e) { Assert.assertNotEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: No Devices Found for the given input search criteria"
	 * , e.toString()); }
	 * 
	 * }
	 * 
	 * @Test public void convertCoherenceAccesoryToAccessory() {
	 * DaoUtils.convertCoherenceAccesoryToAccessory(CommonMethods.
	 * getCommercialProduct(),
	 * CommonMethods.GetPriceforproduct().getPriceForAccessoryes().get(0)); }
	 * 
	 * public void nullTestgetListOfDeviceDetailsForException() { Map<String,
	 * String> queryparams = new HashMap<>(); queryparams.put("journeyType",
	 * null); queryparams.put("offerCode", "W_HH_OC_01");
	 * queryparams.put("deviceId", "093353");
	 * deviceController.getListOfDeviceDetails(queryparams); }
	 * 
	 * public void nullTestgetListOfDeviceDetailsForException1() { Map<String,
	 * String> queryparams = new HashMap<>(); queryparams.put("journeyType",
	 * "journeyType"); queryparams.put("offerCode", "W_HH_OC_01");
	 * queryparams.put("deviceId", "093353");
	 * deviceController.getListOfDeviceDetails(queryparams); }
	 * 
	 * @Test public void notNullTestForGetAccessoriesOfDeviceDao() { try {
	 * DaoUtils.convertCoherenceAccesoryToAccessory(CommonMethods.
	 * getCommercialProduct2(), CommonMethods.getPriceForAccessory()); } catch
	 * (Exception e) {
	 * 
	 * } }
	 * 
	 ...
	 * @JsonIgnore
	 * 
	 * @Test public void notNullTestForcacheDeviceTileWithoutOfferCode() throws
	 * JsonParseException, JsonMappingException, IOException {
	 * ServiceContext.urlParamContext.remove(); List<FilterCriteria> fcList =
	 * new ArrayList<FilterCriteria>(); fcList.add(new
	 * FilterCriteria("groupType", FilterOperator.EQUALTO, "DEVICE_PAYM"));
	 ...
	 * .anyObject())) .willReturn(CommonMethods.getModel()); //
	 * given(deviceDAOMock.getStockAvailabilityByMemberId(Matchers.anyString()))
	 * .willReturn(CommonMethods.getStockAvailability()); //
	 * given(deviceDAOMock.getStockAvailabilityByMemberId(Matchers.anyString()))
	 * .willReturn(CommonMethods.getStockAvailability()); ObjectMapper mapper =
	 ...
	 * deviceController.cacheDeviceTile(); }
	 * 
	 * @Test public void nullTestForCacheDeviceTile() {
	 * ServiceContext.urlParamContext.remove(); List<FilterCriteria> fcList =
	 * new ArrayList<FilterCriteria>(); fcList.add(new
	 * FilterCriteria("groupType", FilterOperator.EQUALTO, ""));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null)); try{ deviceController.cacheDeviceTile(); } catch(Exception e){
	 * try{ ServiceContext.urlParamContext.remove(); fcList = new
	 * ArrayList<FilterCriteria>(); fcList.add(new FilterCriteria("groupType",
	 * FilterOperator.EQUALTO, "INVALID_GT"));
	 * ServiceContext.setURLParamContext(new URLParamContext("", "", fcList,
	 * null)); deviceController.cacheDeviceTile(); } catch(Exception ex){} } }
	 * 
	 *//**
	 ...
	 * @JsonIgnore
	 * 
	 * @Test public void test_Controller_getDeviceReviewDetailsValidInput(){
	 * try{ given(deviceDAOMock.getDeviceReviewDetails(Matchers.anyString())).
	 * willReturn(CommonMethods.getReviewsJson());
	 * deviceController.getDeviceReviewDetails("093353"); }catch(Exception
	 * exception){ //assertEquals(
	 * "com.vf.uk.dal.common.exception.ApplicationException: No reviews found for the given deviceId"
	 * , exception.toString()); } }
	 * 
	 *//**
		 * End
		 *//*
		 * 
		 * @Test public void notNullTestForgetDeviceDetails1() { DeviceDetails
		 * deviceDetails = new DeviceDetails(); given(restTemplate.getForObject(
		 * "http://BUNDLES-V1/bundles/catalogue/bundle/queries/byCoupledBundleList/?deviceId=093353",
		 * BundleDetailsForAppSrv.class)).willReturn(CommonMethods.
		 * getCoupledBundleListForDevice()); deviceDetails =
		 * deviceController.getDeviceDetails("093353",null,null);
		 * Assert.assertNotNull(deviceDetails); }
		 * 
		 * @Test public void notNullTestForGetDeviceDetailsTile_PAYG() {
		 * List<DeviceTile> deviceDetails = null; try { deviceDetails =
		 * deviceController.getListOfDeviceTile("Apple", "iPhone-7",
		 * "DEVICE_PAYG", null, null, null, null, null);
		 * Assert.assertNotNull(deviceDetails); } catch (Exception e) {
		 * 
		 * }
		 * 
		 ...
		 * 
		 * @Test public void
		 * testGetListOfDeviceTileForInvalidMakeAndModel_PAYG() {
		 * List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
		 * deviceController.getListOfDeviceTile("Vodafone", "iPhone-7",
		 * "DEVICE_PAYG", null, null, null, null, null); } catch (Exception e) {
		 * Assert.assertEquals(
		 * "com.vf.uk.dal.common.exception.ApplicationException: No Devices Found for the given input search criteria"
		 * , e.toString()); } }
		 * 
		 * @Test public void testGetListOfDeviceTileForInvalidJourneyType_PAYG()
		 * { List<DeviceTile> listOfDeviceTile = null; try { listOfDeviceTile =
		 * deviceController.getListOfDeviceTile("Apple", "iPhone-7",
		 * "DEVICE_PAYG", "Upgrade", null, null, null, null); } catch (Exception
		 * e) { Assert.assertEquals(
		 ...
		 * 
		 * @Test public void
		 * notNullTestForcacheDeviceTileWithoutOfferCodeForPAYG() throws
		 * JsonParseException, JsonMappingException, IOException {
		 * List<FilterCriteria> fcList = new ArrayList<FilterCriteria>();
		 * fcList.add(new FilterCriteria("groupType", FilterOperator.EQUALTO,
		 * "DEVICE_PAYG")); ServiceContext.setURLParamContext(new
		 * URLParamContext("", "", fcList, null));
		 * given(deviceDAOMock.insertCacheDeviceToDb()).willReturn(CommonMethods
		 * .getCacheDeviceTileResponse()); Collection<CommercialProduct> a = new
		 * ArrayList<>(); a.add(CommonMethods.getCommercialProduct5());
		 * given(this.response.getListOfMerchandisingPromotionModelFromJson(
		 * Matchers.anyObject())) .willReturn(CommonMethods.getModel());
		 * ObjectMapper mapper = new ObjectMapper();
		 * mapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
		 * mapper.enable(DeserializationFeature.ACCEPT_SINGLE_VALUE_AS_ARRAY);
		 * String jsonString = new
		 * String(Utility.readFile("\\TEST-MOCK\\PRICE_FOR_PAYG.json"));
		 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[] obj =
		 * mapper.readValue(jsonString,
		 * com.vf.uk.dal.utility.entity.PriceForBundleAndHardware[].class);
		 * given(registry.getRestTemplate()).willReturn(restTemplate);
		 ...
		 * .willReturn(ratingmap); List<BundleAndHardwareTuple> bundleList = new
		 * ArrayList<>(); RequestForBundleAndHardware
		 * requestForBundleAndHardware = new RequestForBundleAndHardware();
		 * BundleAndHardwareTuple bundle = new BundleAndHardwareTuple();
		 * bundle.setBundleId(null); bundle.setHardwareId("123");
		 ...
		 * deviceController.cacheDeviceTile(); }
		 * 
		 * @Test public void InvalidTestForgetDeviceDetailsWithJourneyTypePAYG()
		 * {
		 * 
		 * try{ DeviceDetails deviceDetails = new DeviceDetails(); deviceDetails
		 * = deviceController.getDeviceDetails("088417", "Upgrade", null);
		 * }catch (Exception e) { Assert.assertEquals(
		 * "com.vf.uk.dal.common.exception.ApplicationException: JourneyType is not compatible for given DeviceId"
		 * ,e.toString()); } }
		 * 
		 * @Test public void InvalidTestForgetDeviceDetailsWithOfferCodePAYG() {
		 * try{ DeviceDetails deviceDetails = new DeviceDetails(); deviceDetails
		 * = deviceController.getDeviceDetails("088417", "abcd", "W_HH_OC_01");
		 * }catch (Exception e) { Assert.assertEquals(
		 * "com.vf.uk.dal.common.exception.ApplicationException: offerCode is not compatible for given DeviceId"
		 * ,e.toString()); } }
		 * 
		 * @Test public void notNullTestForgetDeviceDetailsPAYG() {
		 * 
		 * DeviceDetails deviceDetails = new DeviceDetails(); deviceDetails =
		 * deviceController.getDeviceDetails("088417", "abcd", null);
		 * Assert.assertNotNull(deviceDetails); }
		 * 
		 * @Test public void
		 * notNullTestConvertCoherenceDeviceToDeviceTile_PAYG(){
		 * DaoUtils.convertCoherenceDeviceToDeviceTile_PAYG(Long.parseLong("1"),
		 ...
		 * 
		 * @Test public void notNullTestgetListOfOfferAppliedPrice(){
		 * DaoUtils.getBundlePriceBasedOnDiscountDuration(CommonMethods.
		 * getBundlePrice(), "conditional_full_discount"); }
		 * 
		 * @Test public void
		 * notNullgetListOfPriceForBundleAndHardwareForDevice(){ DaoUtils
		 * dao=new DaoUtils();
		 * dao.getListOfPriceForBundleAndHardwareForDevice(CommonMethods.
		 * getBundleHeaderList("SIMO")); }
		 * 
		 * @Test public void notNullassembleMerchandisingPromotion(){
		 * DaoUtils.assembleMerchandisingPromotion(CommonMethods.
		 * getListOfBundleAndHardwarePromotions().get(0),
		 * CommonMethods.getBundleAndHardwareEntertainmentPacks(),
		 * CommonMethods.getBundleAndHardwareAllowance(),
		 * CommonMethods.getBundleAndHardwareCouplingPromotions(),
		 * CommonMethods.getCataloguepromotionqueriesForBundleAndHardwareSash(),
		 * CommonMethods.
		 * getCataloguepromotionqueriesForBundleAndHardwareSecureNet(),
		 * CommonMethods.getCataloguepromotionqueriesForHardwareSash(),
		 * CommonMethods.getCataloguepromotionqueriesForBundleAndHardwareExtras(
		 * ), CommonMethods.
		 * getCataloguepromotionqueriesForBundleAndHardwareAccessory(),
		 * CommonMethods.getCataloguepromotionqueriesForBundleAndHardwareExtras(
		 * ), CommonMethods.
		 * getCataloguepromotionqueriesForBundleAndHardwareAccessory(),
		 * CommonMethods.getCataloguepromotionqueriesForBundleAndHardwareExtras(
		 ...
		 * ; }
		 * 
		 * @Test public void notNullgetListOfIlsPriceWithoutOfferCode(){
		 * List<com.vf.uk.dal.utility.entity.PriceForBundleAndHardware>
		 * listOfPriceForBundleAndHardwareWithoutOfferCodeForUpgrade=
		 * CommonMethods.getOfferAppliedPrice(); Map<String, Map<String,
		 * List<com.vf.uk.dal.utility.entity.PriceForBundleAndHardware>>>
		 * mapOfIlsPriceWithoutOfferCode = new HashMap<>();
		 * mapOfIlsPriceWithoutOfferCode.put(Constants.JOURNEY_TYPE_UPGRADE,
		 * DaoUtils.getILSPriceWithoutOfferCode(
		 * listOfPriceForBundleAndHardwareWithoutOfferCodeForUpgrade));
		 * 
		 * DaoUtils.getListOfIlsPriceWithoutOfferCode("093353",
		 * mapOfIlsPriceWithoutOfferCode); }
		 * 
		 * @Test public void
		 * notNullgetListOfPriceForBundleAndHardwareForCacheDevice(){ DaoUtils
		 * dao=new DaoUtils(); Map<String, CommercialBundle>
		 * commercialbundleMap=new HashMap<>();
		 * commercialbundleMap.put("093353",
		 * CommonMethods.getCommercialBundleFromCommercialBundleRepository());
		 * dao.getListOfPriceForBundleAndHardwareForCacheDevice(CommonMethods.
		 * getOfferAppliedPrice(), commercialbundleMap, "Upgrade"); }
		 * 
		 * @Test public void notNullpopulateMerchandisingPromotions(){
		 * DaoUtils.populateMerchandisingPromotions(CommonMethods.
		 * getPriceForBundleAndHardware1().get(0),
		 * CommonMethods.getBundlePriceForUtility()); }
		 * 
		 * 
		 * 
		 * @Test public void notNullTestForgetAccessoriesOfDevice(){
		 * BundleDeviceAndProductsList deviceAndProductsList = new
		 * BundleDeviceAndProductsList(); List<String> accessory=new
		 * ArrayList<>(); accessory.add("093329");accessory.add("085145");
		 ...
		 * given(response.getCommercialProduct(Matchers.anyObject())).willReturn
		 * (CommonMethods.getCommercialProductByDeviceIdForAccessory());
		 * Assert.assertNotNull(deviceController.getAccessoriesOfDevice("093353"
		 * ,null,null));
		 * 
		 * }
		 * 
