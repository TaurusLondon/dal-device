...
public class OtherServiesTest {
	...
	public void testGetConditionalCriteriaForDeviceList() {
		...
		given(deviceConditionallHelper.calculatePlan(Matchers.anyFloat(), Matchers.any(), Matchers.any())).willReturn(bundleModelAndPrice);
		List<String> variantsList = new ArrayList<String>();
		variantsList.add("093353|1");
		variantsList.add("092660|5");
		deviceService.getConditionalCriteriaForDeviceList(40.0F, new HashMap<>(), new HashMap<>(), new ArrayList<>(), new ArrayList<>(), variantsList);
	}
	@Test
	public void testCacheDeviceTileStatus() {
		given(cacheDeviceAndReviewController.getCacheDeviceJobStatus("testID")).willReturn(CommonMethods.getCacheDeviceTileResponse());
	...
	@Test
	public void nullDeviceIdTestgetListOfDeviceDetailsForException1() {
		try {
			Map<String, String> queryparams = new HashMap<>();
			queryparams.put("journeyType", "journeyType");
			queryparams.put("offerCode", "W_HH_OC_01");
	...
	public void notNullTestForgetListOfDeviceDetailsWithoutLeadPlanId() {
		...
		given(response.getMerchandisingPromotion(Matchers.anyObject())).willReturn(CommonMethods.getMerchPromotionForListOfDevicedetails());
		given(deviceDAOMock.getPriceForBundleAndHardware(Matchers.anyList(), Matchers.anyString(),
				Matchers.anyString())).willReturn(CommonMethods.getPriceForBundleAndHardwareListFromTupleList());
		deviceDetails = deviceDetailsController
				.getListOfDeviceDetails(CommonMethods.getQueryParamsMapForDeviceDetails("093353"));
	...
	@Test
	public void TestDeviceServiceImplUtility1(){
		try {
			DeviceServiceImplUtility.getJourney(Constants.JOURNEY_TYPE_SECONDLINE);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility2(){
		try {
	...
	@Test
	public void TestDeviceServiceImplUtility3(){
		try {
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			Device device2 = CommonMethods.getDevice2();
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device2);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility4(){
		try {
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			Device device1 = CommonMethods.getDevice1();
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device1);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility2HW(){
		try {
	...
	@Test
	public void TestDeviceServiceImplUtility3HW(){
		try {
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			Device device2 = CommonMethods.getDevice2HW();
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device2);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility4HW(){
		try {
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			Device device1 = CommonMethods.getDevice1HW();
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device1);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility4WithDATA(){
		try {
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			Device device1 = CommonMethods.getDevice1WithDetails();
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device1);
		}catch(Exception e){}
	}
	@Test
	public void TestDeviceServiceImplUtility2HWWithDATA(){
		try {
			Device device = CommonMethods.getDevice2WithDetails();
			Map<String, MerchandisingPromotion> map = new HashMap<>();
			map.put("1234", CommonMethods.getMP());
			DeviceServiceImplUtility.getPromotionForDeviceList(map, device);
		}catch(Exception e){}
	...
	public void TestDeviceServiceImplUtilityyy(){
		try {
			...
			//DeviceServiceImplUtility.getBundleAndHardwareList(groupType, journeyType, bundleHardwareTupleList, productModel);
		}catch(Exception e){}
	}
	@Test
	public void TestgetBundleAndHardwareList(){
		try {
			...
			DeviceServiceImplUtility.getBundleAndHardwareList
			(Constants.STRING_DEVICE_PAYM, "", bundleHardwareTupleList, pm);
		}catch(Exception e){}
	}
	@Test
	public void TestgetBundleAndHardwareList1(){
		try {
			ProductModel pm = new ProductModel();
	...
	@Test
	public void TestgetBundleAndHardwareList2(){
		try {
			ProductModel pm = new ProductModel();
			pm.setUpgradeLeadPlanId("1212");
			pm.setNonUpgradeLeadPlanId("1212");
			List<BundleAndHardwareTuple> bundleHardwareTupleList = new ArrayList<>();
			DeviceServiceImplUtility.getBundleAndHardwareList
			(Constants.STRING_DEVICE_PAYM, "Acquisition", bundleHardwareTupleList, pm);
		}catch(Exception e){}
	}
	@Test
	public void TestgetBundleAndHardwareList3(){
		try {
			ProductModel pm = new ProductModel();
			pm.setUpgradeLeadPlanId("1212");
			pm.setNonUpgradeLeadPlanId("1212");
			List<BundleAndHardwareTuple> bundleHardwareTupleList = new ArrayList<>();
			DeviceServiceImplUtility.getBundleAndHardwareList
			(Constants.STRING_DEVICE_PAYM, Constants.JOURNEY_TYPE_UPGRADE, bundleHardwareTupleList, pm);
		}catch(Exception e){}
	}
	@Test
	public void TestgetBundleAndHardwareList12(){
		try {
			ProductModel pm = new ProductModel();
			pm.setUpgradeLeadPlanId("");
			pm.setNonUpgradeLeadPlanId("");
	...
	@Test
	public void TestgetBundleAndHardwareList4(){
		try {
			ProductModel pm = new ProductModel();
			pm.setUpgradeLeadPlanId("1212");
			pm.setNonUpgradeLeadPlanId("1212");
			List<BundleAndHardwareTuple> bundleHardwareTupleList = new ArrayList<>();
			DeviceServiceImplUtility.getBundleAndHardwareList
			(Constants.STRING_DEVICE_PAYG, Constants.JOURNEY_TYPE_ACQUISITION, bundleHardwareTupleList, pm);
		}catch(Exception e){}
	}
	@Test
	public void TestgetBundleAndHardwareList5(){
		try {
			ProductModel pm = new ProductModel();
			pm.setUpgradeLeadPlanId("1212");
			pm.setNonUpgradeLeadPlanId("1212");
			List<BundleAndHardwareTuple> bundleHardwareTupleList = new ArrayList<>();
			DeviceServiceImplUtility.getBundleAndHardwareList
			(Constants.STRING_DEVICE_PAYM, Constants.JOURNEY_TYPE_ACQUISITION, bundleHardwareTupleList, pm);
		}catch(Exception e){}
	}
	@Test
	...
	@Test
	public void TestgetStartdateFromProductModel1(){
		try {
			ProductModel pm = new ProductModel();
	...
	@Test
	public void TestgetStartdateFromProductModel2(){
		try {
			ProductModel pm = new ProductModel();
	...
	@Test
	public void TestgetEnddateFromProductModel1(){
		try {
			ProductModel pm = new ProductModel();
	...
	@Test
	public void TestgetEnddateFromProductModel2(){
		try {
			ProductModel pm = new ProductModel();
	...
	public void TestdateValidation(){
		try {
			...
			DeviceServiceImplUtility.dateValidation(new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2018"), startDate, true);
			DeviceServiceImplUtility.dateValidation(new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2018"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), true);
			DeviceServiceImplUtility.dateValidation(new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2018"),new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2019"), true);
			...
			DeviceServiceImplUtility.getDateForValidation(currentDate,startDate, endDate);
			DeviceServiceImplUtility.getDateForValidation(currentDate,new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), startDate);
			DeviceServiceImplUtility.getDateForValidation(currentDate,new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"));
			DeviceServiceImplUtility.getDateForValidation(currentDate,new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"),new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"));
			DeviceServiceImplUtility.getDateForValidation(currentDate,new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), currentDate);
		...
		try{
			...
			DeviceServiceImplUtility.getPricingMap
			(bundleAndHardwareTupleList, fromPricingMap, leadPlanIdMap, listofLeadPlan, cp);
		}catch(Exception e){}
	...
	public void TestisMember(){
		try {
			...
			DeviceServiceImplUtility.isMember
			( Constants.JOURNEY_TYPE_UPGRADE, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), pm, true);
		}catch(Exception e){}
	}
	@Test
	public void TestisMember1(){
		try {
			...
			pm.setIsSellableRet("true");
			DeviceServiceImplUtility.isMember
			( Constants.JOURNEY_TYPE_ACQUISITION, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), pm, true);
		}catch(Exception e){}
	}
	@Test
	public void TestisMember11(){
		try {
			ProductModel pm = new ProductModel();
	...
	public void TestisUpgrade(){
		try {
			...
			pm.setIsDisplayableRet("true");
			pm.setIsSellableRet("true");
			DeviceServiceImplUtility.isUpgradeCheck
			( Constants.JOURNEY_TYPE_UPGRADE, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), pm, true);
		}catch(Exception e){}
	}
	@Test
	public void TestisUpgradeCheck1(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
			pm.setIsDisplayableRet("true");
	...
	@Test
	public void TestisUpgradeCheck11(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_ACCESSORY);
			pm.setIsDisplayableRet("true");
	...
	@Test
	public void TestisUpgradeCheck3(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
			pm.setIsDisplayableRet("false");
	...
	@Test
	public void TestisUpgradeCheck4(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
			pm.setIsDisplayableRet("false");
			...
			DeviceServiceImplUtility.isUpgradeCheck
			( Constants.JOURNEY_TYPE_UPGRADE, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), pm, true);
		}catch(Exception e){}
	}
	@Test
	public void TestisNonUpgrade(){
		try {
			...
			pm.setIsDisplayableRet("true");
			pm.setIsSellableRet("true");
			DeviceServiceImplUtility.isNonUpgradeCheck
			( Constants.JOURNEY_TYPE_ACQUISITION, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), pm, true);
		}catch(Exception e){}
	}
	@Test
	public void TestisNonUpgradeCheck1(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
			pm.setIsDisplayableRet("true");
	...
	@Test
	public void TestisNonUpgradeCheck11(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_ACCESSORY);
	...
	@Test
	public void TestisNonUpgradeCheck3(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
	...
	@Test
	public void TestisNonUpgradeCheck4(){
		try {
			ProductModel pm = new ProductModel();
			pm.setProductClass(Constants.STRING_HANDSET);
			pm.setIsDisplayableAcq("false");
			pm.setIsSellableAcq("true");
			DeviceServiceImplUtility.isNonUpgradeCheck
			( Constants.JOURNEY_TYPE_ACQUISITION, new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-3000"), new SimpleDateFormat(Constants.DATE_FORMAT).parse("21-11-2017"), pm, true);
		}catch(Exception e){}
	}
	@Test
	...
	@Test
	public void TestisNonUpgrade12(){
		try {
	...
	public void TestgetBundlePriceBasedOnDiscountDuration_Implementation(){
		...
		try {
			DeviceServiceImplUtility.getBundlePriceBasedOnDiscountDuration_Implementation
			(null, Constants.FULL_DURATION_DISCOUNT);
		}catch(Exception e){}
		try {
			DeviceServiceImplUtility.getBundlePriceBasedOnDiscountDuration_Implementation
			(null, Constants.LIMITED_TIME_DISCOUNT);
		}catch(Exception e){}
		try {
			DeviceServiceImplUtility.getBundlePriceBasedOnDiscountDuration_Implementation
			(null,"abc");
		...
		try {
			...
			ds.setPriceInfo(pb);
			DeviceServiceImplUtility.getBundlePriceBasedOnDiscountDuration_Implementation
			(ds,Constants.FULL_DURATION_DISCOUNT);
		}catch(Exception e){}
		try {
			DeviceSummary ds = new DeviceSummary();
			PriceForBundleAndHardware pb = new PriceForBundleAndHardware();
		...
		try {
			...
			ds.setPriceInfo(pb);
			DeviceServiceImplUtility.getBundlePriceBasedOnDiscountDuration_Implementation
			(ds,Constants.LIMITED_TIME_DISCOUNT);
		}catch(Exception e){}
		try {
			DeviceSummary ds = new DeviceSummary();
			PriceForBundleAndHardware pb = new PriceForBundleAndHardware();
